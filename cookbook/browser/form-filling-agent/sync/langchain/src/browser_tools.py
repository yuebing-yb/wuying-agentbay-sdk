...
try:
    from agentbay import AgentBay, ActOptions
...
def browser_act(
    ...
    try:
        ...
        result = session.browser.agent.act(act_options)
...
def browser_screenshot(
    ...
    try:
        ...
        screenshot_result = session.browser.agent.screenshot()
