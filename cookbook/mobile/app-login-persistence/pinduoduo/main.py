...
# Configuration
# Note: Ensure the image has Pinduoduo app installed
IMAGE_NAME = "imgc-0aae4rgl3u35xrhoe"
APP_DATA_PATH = "/data/data/com.xunmeng.pinduoduo/files/mmkv"
CONTEXT_NAME = "pdd-login-persistence-ctx"
...
async def main():
    ...
    print("2. Login to the 'Pinduoduo' app.")
