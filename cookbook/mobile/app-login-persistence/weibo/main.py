...
# Configuration
# Note: Ensure the image has Weibo app installed
IMAGE_NAME = "imgc-0aae4rgl3u35xrhoe"
APP_DATA_PATH = "/data/data/com.sina.weibo/"
CONTEXT_NAME = "weibo-login-persistence-ctx"
...
async def main():
    ...
    print("2. Login to the 'Weibo' app.")
