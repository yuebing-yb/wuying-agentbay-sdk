...
APP_DATA_PATH = "/data/data/com.xingin.xhs/files/mmkv"
CONTEXT_NAME = "xhs-login-persistence-ctx"
...
async def main():
    ...
    print("2. Login to the 'Xiaohongshu' (Red) app.")
