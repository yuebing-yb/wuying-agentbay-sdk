...
from ..config import _BROWSER_DATA_PATH, _BROWSER_FINGERPRINT_PERSIST_PATH
from ..logger import get_logger, _log_api_response_with_details
    ...
    async def get_endpoint_url_async(self) -> str:
        ...
        try:
            if self.session.is_vpc:
                ...
                # Async call
                response = await self.session.agent_bay.client.get_cdp_link_async(request)
