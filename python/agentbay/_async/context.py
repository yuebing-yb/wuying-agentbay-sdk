...
class AsyncContextService:
    ...
    async def list(self, params: Optional[ContextListParams] = None) -> ContextListResult:
        ...
        try:
            ...
            response = await self.agent_bay.client.list_contexts_async(request)
            try:
    ...
    async def get(
        ...
        try:
            ...
            response = await self.agent_bay.client.get_context_async(request)
            try:
                response_body = json.dumps(
                    response.to_map().get("body", {}), ensure_ascii=False, indent=2
                )
    ...
    async def create(self, name: str) -> ContextResult:
        ...
        Example:
            ...
            ```
        """
        return await self.get(name, create=True)
    ...
    async def update(self, context: Context) -> OperationResult:
        ...
        try:
            ...
            response = await self.agent_bay.client.modify_context_async(request)
            try:
                response_body = json.dumps(
                    response.to_map().get("body", {}), ensure_ascii=False, indent=2
                )
    ...
    async def delete(self, context: Context) -> OperationResult:
        ...
        try:
            ...
            response = await self.agent_bay.client.delete_context_async(request)
            try:
                response_body = json.dumps(
                    response.to_map().get("body", {}), ensure_ascii=False, indent=2
                )
    ...
    async def get_file_download_url(self, context_id: str, file_path: str) -> FileUrlResult:
        ...
        resp = await self.agent_bay.client.get_context_file_download_url_async(req)
        try:
            response_body = json.dumps(
    ...
    async def get_file_upload_url(self, context_id: str, file_path: str) -> FileUrlResult:
        ...
        resp = await self.agent_bay.client.get_context_file_upload_url_async(req)
        try:
            response_body = json.dumps(
                resp.to_map().get("body", {}), ensure_ascii=False, indent=2
            )
    ...
    async def delete_file(self, context_id: str, file_path: str) -> OperationResult:
        ...
        resp = await self.agent_bay.client.delete_context_file_async(req)
        try:
            response_body = json.dumps(
                resp.to_map().get("body", {}), ensure_ascii=False, indent=2
            )
    ...
    async def list_files(
        ...
        resp = await self.agent_bay.client.describe_context_files_async(req)
        try:
            response_body = json.dumps(
                resp.to_map().get("body", {}), ensure_ascii=False, indent=2
            )
    ...
    async def start_clear(self, context_id: str) -> ClearContextResult:
        ...
        try:
            ...
            response = await self.agent_bay.client.clear_context_async(request)
            try:
                response_body = json.dumps(
                    response.to_map().get("body", {}), ensure_ascii=False, indent=2
                )
    ...
    async def clear(
        ...
        start_result = await self.start_clear(context_id)
        ...
        while attempt < max_attempts:
            ...
            status_result = await self.get_clear_status(context_id)
