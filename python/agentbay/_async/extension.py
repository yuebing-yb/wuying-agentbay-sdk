...
from .._common.models.extension import (
...
class AsyncExtensionsService:
    ...
    **Context Management**:
    ...
    async def _ensure_context(self):
        """
        Lazily ensure the context exists and is initialized.
        """
    ...
    async def update(self, extension_id: str, new_local_path: str) -> Extension:
        """
    ...
    async def delete(self, extension_id: str) -> bool:
        """
    ...
    async def create_extension_option(self, extension_ids: List[str]) -> ExtensionOption:
        """
