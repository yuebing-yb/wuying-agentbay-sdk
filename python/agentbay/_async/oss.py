...
class AsyncOss(AsyncBaseService):
    ...
    async def upload(self, bucket: str, object: str, path: str) -> OSSUploadResult:
        """
    ...
    async def upload_anonymous(self, url: str, path: str) -> OSSUploadResult:
        """
    ...
    async def download(self, bucket: str, object: str, path: str) -> OSSDownloadResult:
        """
    ...
    async def download_anonymous(self, url: str, path: str) -> OSSDownloadResult:
        """
