...
class BrowserContext:
    ...
    def _create_extension_context_syncs(self) -> List[ContextSync]:
        ...
        white_lists = [
            WhiteList(path=f"{ext_id}", exclude_paths=[])
...
class CreateSessionParams:
    ...
    Attributes:
        ...
        network_id (Optional[str]): Network ID to bind this session to.
    """
    ...
    def __init__(
        ...
        Args:
            ...
            policy_id (Optional[str], optional): Policy id to apply when creating the session.
                Defaults to None.
            network_id (Optional[str], optional): Network ID to bind this session to.
                Defaults to None.
