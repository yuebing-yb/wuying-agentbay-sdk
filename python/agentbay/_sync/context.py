...
class ContextService:
    ...
    def list(
        ...
        try:
            ...
            if hasattr(client, "list_contexts") and callable(
                ...
                response = asyncio.to_thread(client.list_contexts, request)
            try:
    ...
    def get(
        ...
        try:
            ...
            if hasattr(client, "get_context") and callable(
                ...
                response = asyncio.to_thread(client.get_context, request)
            try:
                response_body = json.dumps(
                    response.to_map().get("body", {}), ensure_ascii=False, indent=2
                )
    ...
    def update(self, context: Context) -> OperationResult:
        ...
        try:
            ...
            if hasattr(client, "modify_context") and callable(
                ...
                response = asyncio.to_thread(client.modify_context, request)
            try:
                response_body = json.dumps(
                    response.to_map().get("body", {}), ensure_ascii=False, indent=2
                )
    ...
    def delete(self, context: Context) -> OperationResult:
        ...
        try:
            ...
            if hasattr(client, "delete_context") and callable(
                ...
                response = asyncio.to_thread(client.delete_context, request)
            try:
                response_body = json.dumps(
                    response.to_map().get("body", {}), ensure_ascii=False, indent=2
                )
    ...
    def get_file_download_url(
        ...
        if hasattr(client, "get_context_file_download_url") and callable(
            ...
            resp = asyncio.to_thread(client.get_context_file_download_url, req)
        try:
            response_body = json.dumps(
    ...
    def get_file_upload_url(
        ...
        if hasattr(client, "get_context_file_upload_url") and callable(
            ...
            resp = asyncio.to_thread(client.get_context_file_upload_url, req)
        try:
            response_body = json.dumps(
                resp.to_map().get("body", {}), ensure_ascii=False, indent=2
            )
    ...
    def delete_file(self, context_id: str, file_path: str) -> OperationResult:
        ...
        if hasattr(client, "delete_context_file") and callable(
            ...
            resp = asyncio.to_thread(client.delete_context_file, req)
        try:
            response_body = json.dumps(
                resp.to_map().get("body", {}), ensure_ascii=False, indent=2
            )
    ...
    def list_files(
        ...
        if hasattr(client, "describe_context_files") and callable(
            ...
            resp = asyncio.to_thread(client.describe_context_files, req)
        try:
            response_body = json.dumps(
                resp.to_map().get("body", {}), ensure_ascii=False, indent=2
            )
    ...
    def clear_async(self, context_id: str) -> ClearContextResult:
        ...
        try:
            ...
            if hasattr(client, "clear_context") and callable(
                ...
                response = asyncio.to_thread(client.clear_context, request)
            try:
                response_body = json.dumps(
                    response.to_map().get("body", {}), ensure_ascii=False, indent=2
                )
