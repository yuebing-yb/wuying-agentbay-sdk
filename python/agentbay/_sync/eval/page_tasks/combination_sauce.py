...
def run(
    ...
    credentials: LoginCredentials = agent.extract(
    ...
    agent.act("enter username 'standard_user'")
    agent.act(f"enter password {credentials.password}")
    agent.act("click on 'login'")
