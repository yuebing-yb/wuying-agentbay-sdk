# AsyncVolume API Reference

> **💡 Sync Version**: This documentation covers the asynchronous API. For synchronous operations, see [`Volume`](../sync/volume.md).
>
...
```python
async def create(name: str, image_id: str) -> VolumeResult
```
...
```python
async def delete(volume_id: str) -> OperationResult
```
