...
> **💡 Async Version**: This documentation covers the synchronous API. For async/await support, see [`AsyncContextService`](../async/async-context.md) which provides the same functionality with async methods.
