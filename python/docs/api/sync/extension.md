...
> **💡 Async Version**: This documentation covers the synchronous API. For async/await support, see [`AsyncExtensionsService`](../async/async-extension.md) which provides the same functionality with async methods.
...
Initializes the ExtensionsService.

**Arguments**:

- `agent_bay` _AgentBay_ - The AgentBay client instance.
