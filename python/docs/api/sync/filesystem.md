...
> **💡 Async Version**: This documentation covers the synchronous API. For async/await support, see [`AsyncFileSystem`](../async/async-filesystem.md) which provides the same functionality with async methods.
