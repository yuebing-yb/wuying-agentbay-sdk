...
```python
def delete_branch(repo_path: str,
                  branch: str,
                  *,
                  force: bool = False,
                  timeout_ms: Optional[int] = None) -> None
...
```python
def configure_user(repo_path: str,
                   name: str,
                   email: str,
                   *,
                   scope: str = "global",
