...
captcha_pause_event = asyncio.Event()
captcha_resume_or_takeover_event = asyncio.Event()
async def wait_for_captcha_solving(
    captcha_pause_event: asyncio.Event,
    captcha_resume_or_takeover_event: asyncio.Event,
    ...
    try:
        ...
        await asyncio.wait_for(captcha_pause_event.wait(), timeout=captcha_detect_timeout)
        try:
            ...
            await asyncio.wait_for(captcha_resume_or_takeover_event.wait(), timeout=max_captcha_solving_timeout)
...
async def main():
    ...
    try:
        ...
        async with async_playwright() as p:
            ...
            # Wait for captcha solving if needed
            captcha_solved = await wait_for_captcha_solving(captcha_pause_event=captcha_pause_event,
