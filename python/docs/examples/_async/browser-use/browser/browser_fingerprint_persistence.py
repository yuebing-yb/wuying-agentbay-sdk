...
from agentbay._async.browser import BrowserOption, BrowserFingerprint, BrowserFingerprintContext
...
async def run_as_first_time():
    ...
    fingerprint_context_result = await agent_bay.context.get(fingerprint_context_name, True)
