...
async def main():
    ...
    try:
        ...
        title_result = await session.browser.agent.extract("What is the page title?")
        print(f"Page title: {title_result.extracted_content}")

        # Extract page description
        print("\n3. Extracting page description...")
        desc_result = await session.browser.agent.extract("What is the main content or description on this page?")
        ...
        stories_result = await session.browser.agent.extract(
        ...
        structure_result = await session.browser.agent.extract(
        ...
        nav_result = await session.browser.agent.extract(
        ...
        meta_result = await session.browser.agent.extract(
