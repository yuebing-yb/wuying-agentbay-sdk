...
async def main():
    ...
    if session_result.success:
        ...
        await operator.act(ActOptions(action="在页面中点击 '气候' 选项"))
        await operator.act(ActOptions(action="点击 'CO2' 选项，然后点击页面空白处"))
        await operator.act(
        ...
        await operator.act(ActOptions(action="点击 OK 按钮"))
