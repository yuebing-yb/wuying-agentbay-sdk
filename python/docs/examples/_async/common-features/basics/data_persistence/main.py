...
async def data_persistence_demo(agent_bay):
    ...
    context_result = await agent_bay.context.get("persistence-demo", create=True)
    ...
    session1_result = await agent_bay.create(params1)
...
"""
        ...
        delete_result1 = await agent_bay.delete(session1, sync_context=True)  # Sync before deletion
...
"""
        ...
        delete_result2 = await agent_bay.delete(session2, sync_context=True)
