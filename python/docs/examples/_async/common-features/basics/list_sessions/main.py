...
async def main():
    ...
    try:
        ...
        result = await agent_bay.list(labels={"project": "list-demo"})
        if result.success:
        ...
        # Get first page
        result_page1 = await agent_bay.list(labels={"project": "list-demo"}, page=1, limit=2)
        if result_page1.success:
            ...
            if result_page1.next_token:
                ...
                result_page2 = await agent_bay.list(
        ...
        while True:
            result = await agent_bay.list(labels={"owner": "demo-user"}, page=page, limit=limit)
