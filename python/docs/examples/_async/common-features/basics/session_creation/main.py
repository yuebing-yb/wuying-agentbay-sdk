...
async def create_session_with_default_params() -> None:
...
async def create_session_with_labels() -> None:
    ...
    if result.success and result.session:
        ...
        label_result = await session.get_labels()
...
async def create_session_with_context() -> None:
    ...
    context_result = await agent_bay.context.get("example-context", create=True)
...
async def create_session_with_context_sync() -> None:
    """Create a session with context synchronization."""
    # Initialize the AgentBay client
    api_key = os.environ.get("AGENTBAY_API_KEY", "")
    agent_bay = AsyncAgentBay(api_key=api_key)
    ...
    # Create or get a persistent context
    context_result = await agent_bay.context.get("example-sync-context", create=True)
...
async def create_session_with_browser_context() -> None:
    ...
    context_result = await agent_bay.context.get("example-browser-context", create=True)
...
async def create_session_with_mobile_config() -> None:
