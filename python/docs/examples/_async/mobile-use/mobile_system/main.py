...
async def main():
    ...
    try:
        ...
        apps_result = await session.mobile.get_installed_apps(
        ...
        start_result = await session.mobile.start_app(
        ...
        stop_result = await session.mobile.stop_app_by_cmd(
        ...
        elements_result = await session.mobile.get_clickable_ui_elements()
        ...
        all_elements_result = await session.mobile.get_all_ui_elements(timeout_ms=3000)
        ...
        print("\nTapping screen...")
        tap_result = await session.mobile.tap(
