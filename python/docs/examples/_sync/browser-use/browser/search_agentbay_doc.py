    ...
    if session_result.success:
        ...
        if session.browser.initialize(BrowserOption()):
            ...
            with sync_playwright() as p:
                ...
                try:
                    search_input = page.wait_for_selector("//input[contains(@class, 'search-input')]", timeout=10000)
                    search_input.click()
                    search_input.fill("Agentbay帮助文档")
                ...
                try:
                    page.wait_for_selector("//a[contains(@class, 'search-result-title')]", timeout=10000)
                    search_results = page.locator("//a[contains(@class, 'search-result-title')]").all()
                    ...
                    with page.context.expect_page() as new_page_info:
                        ...
                        for selector in selectors_to_try:
                            try:
                                ...
                                new_page.wait_for_selector(selector, timeout=5000)
                                helper_link = new_page.locator(selector).first
                                link_text = helper_link.text_content()
                        ...
                        if helper_link:
                            print("helper_link =", helper_link.text_content())
                            helper_link.click()
                            ...
                            all_links = new_page.locator("a").all()
