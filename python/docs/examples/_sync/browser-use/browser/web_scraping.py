...
def scrape_table_data(page, selector: str) -> List[Dict[str, str]]:
...
def scrape_with_pagination(page, max_pages: int = 3) -> List[Dict[str, Any]]:
    ...
    while current_page <= max_pages:
        ...
        # Scrape current page
        page_data = scrape_basic_data(page)
        page_data["page_number"] = current_page
        all_data.append(page_data)
        
        # Look for next page button
        next_button = page.query_selector('a.next, button.next, a[rel="next"]')
...
def scrape_dynamic_content(page):
...
def save_scraped_data(data: Any, filename: str):
...
def main():
    ...
    try:
        ...
        with sync_playwright() as p:
            ...
            # Scrape basic data
            basic_data = scrape_basic_data(page)
            
            # Save scraped data
            save_scraped_data(basic_data, "/tmp/scraped_data.json")
