...
def main():
    ...
    try:
        ...
        operator.navigate("https://weibo.com")
        operator.act(ActOptions(action=f"点击登录"))
        operator.act(ActOptions(action=f"点击账号登录"))
        ...
        search_keyword = "人工智能"
        operator.act(ActOptions(action=f"在搜索框输入{search_keyword}并回车"))
