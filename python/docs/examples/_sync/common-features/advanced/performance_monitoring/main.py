...
def benchmark_command_execution(session, monitor: PerformanceMonitor, num_iterations: int = 10):
...
def benchmark_file_operations(session, monitor: PerformanceMonitor, num_iterations: int = 10):
...
def benchmark_parallel_operations(session, monitor: PerformanceMonitor):
...
def main():
    ...
    try:
        ...
        benchmark_command_execution(session, monitor, num_iterations=5)
        ...
        benchmark_file_operations(session, monitor, num_iterations=5)
        ...
        benchmark_parallel_operations(session, monitor)
