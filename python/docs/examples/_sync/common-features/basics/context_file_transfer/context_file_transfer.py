...
class ContextFileTransfer:
    ...
    Example:
        ...
        result = transfer.upload_file(ctx_id, "/hello.txt", b"Hello!")
        content = transfer.download_file(ctx_id, "/hello.txt")
    """
    ...
    def upload_file(
        ...
        response = self._http_put(url_result.url, file_data)
    ...
    def download_file(
        ...
        response = self._http_get(url_result.url)
