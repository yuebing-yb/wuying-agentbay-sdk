...
def main():
    ...
    try:
        ...
        context_sync_with_callback_demo(agent_bay)
        ...
        print("="*60)
        context_sync_demo(agent_bay)  # With await
...
def context_sync_with_callback_demo(agent_bay):
...
def context_sync_demo(agent_bay):
    """Method 2: Sync interface with - wait for completion"""
    print("\n🔄 Method 2: context_sync (Sync with await)")
    print("📤 This method uses to wait for completion")
