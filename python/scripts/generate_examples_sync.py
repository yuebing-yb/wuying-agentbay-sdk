...
def convert_file(src_path: Path, dest_path: Path):
    ...
    # Replace internal module imports: _async -> _sync
    code = code.replace("from agentbay._async.", "from agentbay._sync.")
    code = code.replace("from agentbay._common.exceptions import AgentBayError", "from agentbay._common.exceptions import AgentBayError")
