...
def _write_sync_ws_client_stub() -> None:
    """
    Write a safe stub for sync WS client.

    Long connection is implemented async-first. The sync SDK doesn't support it yet.
    """
    internal_dir = os.path.join(SYNC_DIR, "_internal")
    os.makedirs(internal_dir, exist_ok=True)
    path = os.path.join(internal_dir, "ws_client.py")
    content = (
...
def _write_sync_ws_streaming_unit_test_stub() -> None:
    """
    Write a sync unit test stub for WS streaming.

    WS long connection is async-only for now, so sync should fail fast.
    """
    os.makedirs(UNIT_TEST_SYNC_DIR, exist_ok=True)
    path = os.path.join(UNIT_TEST_SYNC_DIR, "test_run_code_ws_streaming.py")
    content = (
        "# -*- coding: utf-8 -*-\n"
        "import pytest\n\n\n"
        "@pytest.mark.unit\n"
...
def _write_sync_ws_streaming_integration_test_stub() -> None:
    ...
    path = os.path.join(TEST_SYNC_DIR, "test_run_code_ws_streaming_integration.py")
    content = (
        "# DO NOT EDIT THIS FILE MANUALLY.\n"
        "# This file is auto-generated by scripts/generate_sync.py\n\n"
        "# -*- coding: utf-8 -*-\n"
...
def generate_sync():
    ...
    # Write stubs for skipped async-only modules
    _write_sync_ws_client_stub()
    _write_sync_ws_streaming_unit_test_stub()
    _write_sync_ws_streaming_integration_test_stub()
