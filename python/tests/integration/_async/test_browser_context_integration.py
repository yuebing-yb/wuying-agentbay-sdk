...
@pytest.fixture(scope="module")
async def browser_context_fixture(agent_bay):
...
@pytest.mark.asyncio
async def test_browser_context_cookie_persistence(agent_bay, browser_context_fixture):
    ...
    session_result2 = await agent_bay.create(params)
