...
from agentbay import AsyncAgentBay, CreateSessionParams, AgentBayLogger, get_logger
...
@pytest.mark.asyncio
async def test_context_sync_immediate_file_availability(agent_bay):
    """
    ...
    try:
        ...
        try:
            ...
            delete_context_result = await agent_bay.context.delete(context_obj)
