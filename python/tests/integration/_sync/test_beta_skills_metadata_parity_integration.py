...
from agentbay import AgentBay, AgentBay
...
@pytest.mark.sync
def test_beta_skills_list_metadata_sync_async_parity(
    agent_bay_async: AgentBay, agent_bay_sync: AgentBay
):
    async_items = agent_bay_async.beta.skills.list_metadata()
