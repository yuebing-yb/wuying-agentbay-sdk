...
def test_initialize_browser(browser_session):
    ...
    asyncio.sleep(1)  # Reduced for faster testing  # Reduced for faster testing
...
def test_initialize_browser_with_fingerprint(browser_session):
    ...
    asyncio.sleep(3)  # Reduced for faster testing
...
def test_initialize_browser_with_captchas(browser_session):
    ...
    with sync_playwright() as p:
        ...
        asyncio.sleep(10)  # Reduced from 30s for faster testing
...
def test_restricted_proxy_ip_comparison(browser_session):
    ...
    asyncio.sleep(2)  # Reduced for faster testing
    ...
    with sync_playwright() as p:
        ...
        for i in range(5):
            ...
            try:
                ...
                asyncio.sleep(1)  # wait for proxy to change - reduced for faster testing
            except Exception as e:
