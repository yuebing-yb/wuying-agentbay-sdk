...
from agentbay._sync.browser_operator import ActOptions, ExtractOptions, ObserveOptions
...
def test_act_success(browser_session):
    ...
    with sync_playwright() as p:
        ...
        result = browser.operator.act(ActOptions(action="Click search button"), page)
        print("result =", result)
...
def test_observe_success(browser_session):
    ...
    with sync_playwright() as p:
        ...
        result, observe_results = browser.operator.observe(
