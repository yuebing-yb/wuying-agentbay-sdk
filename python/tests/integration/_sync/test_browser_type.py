...
@pytest.mark.asyncio
def test_browser_type_default_none(computer_session):
    ...
    success = computer_session.browser.initialize(browser_option)
    ...
    # Get endpoint URL
    endpoint_url = computer_session.browser.get_endpoint_url()
    assert endpoint_url is not None
    print(f"Browser endpoint URL: {endpoint_url}")


@pytest.mark.asyncio
def test_browser_type_chrome(computer_session):
...
@pytest.mark.asyncio
def test_browser_type_chromium_explicit(computer_session):
...
@pytest.mark.asyncio
def test_browser_type_with_other_options(computer_session):
...
@pytest.mark.asyncio
def test_browser_type_serialization():
...
@pytest.mark.asyncio
def test_browser_type_standard_image_fallback(browser_session):
    ...
    success = browser_session.browser.initialize(browser_option)
