...
@pytest.mark.sync
def test_create_session_with_default_file_upload_mode(agent_bay, unique_id):
...
@pytest.mark.sync
def test_context_sync_with_archive_mode_and_file_operations(agent_bay, unique_id):
...
@pytest.mark.sync
def test_invalid_upload_mode_with_policy_assignment(agent_bay, unique_id):
...
@pytest.mark.sync
def test_valid_upload_mode_values(agent_bay, unique_id):
