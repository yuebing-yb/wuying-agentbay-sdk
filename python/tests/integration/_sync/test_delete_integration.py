...
class TestDeleteIntegration:
    ...
    @pytest.mark.asyncio
    def test_delete_without_params(self, agent_bay):
    ...
    @pytest.mark.asyncio
    def test_delete_with_sync_context(self, agent_bay):
        ...
        # Clean up context
        try:
            context_delete_result = agent_bay.context.delete(context)
    ...
    @pytest.mark.asyncio
    def test_agentbay_delete_with_sync_context(self, agent_bay):
