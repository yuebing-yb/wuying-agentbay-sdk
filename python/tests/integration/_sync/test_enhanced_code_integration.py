...
@pytest.mark.sync
def test_enhanced_result_structure(session):
...
@pytest.mark.sync
def test_multiple_results_formats(session):
...
@pytest.mark.sync
def test_execution_timing(session):
...
@pytest.mark.sync
def test_error_details(session):
...
@pytest.mark.sync
def test_javascript_enhanced_features(session):
...
@pytest.mark.sync
def test_large_output_handling(session):
...
@pytest.mark.sync
def test_execution_count_tracking(session):
...
@pytest.mark.sync
def test_mixed_output_types(session):
...
@pytest.mark.sync
def test_empty_code_execution(session):
...
@pytest.mark.sync
def test_backward_compatibility_properties(session):
...
@pytest.mark.sync
def test_markdown_output(session):
