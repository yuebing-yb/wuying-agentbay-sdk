...
def list_loaded_extensions(cdp_ws_url: str):
...
"""
    ...
    def test_extension_create_operation(self):
        ...
        new_extension = self.extensions_service.create(
            local_path=self.sample_extensions[0]
        )
    ...
    def _create_browser_session(self, extension_ids: List[str]):
        ...
        extension_option = self.extensions_service.create_extension_option(
            extension_ids
        )
    ...
    def _extract_and_validate_real_extension_ids(self, session) -> List[str]:
        ...
        try:
            ...
            extensions = list_loaded_extensions(endpoint_url)
    ...
    def _comprehensive_browser_extension_verification_with_real_ids(
        ...
        try:
            ...
            results["file_system_check"] = self._verify_extension_files(
            ...
            results["browser_api_detection"] = self._detect_loaded_extensions(
    ...
    def _validate_extension_contexts(
    ...
    def _verify_extension_files(self, session, extension_ids: List[str]) -> bool:
        ...
        try:
            ...
            for ext_id in extension_ids:
                ...
                folder_check = session.command.execute_command(
                ...
                if folder_check.success:
                    ...
                    manifest_check = session.command.execute_command(
    ...
    def _extract_real_extension_ids_from_browser(self, session) -> List[str]:
    ...
    def _detect_loaded_extensions(
        ...
        try:
            ...
            chrome_extension_ids = self._extract_real_extension_ids_from_browser(
                session
            )
    ...
    def _check_basic_extension_environment(
    ...
    def _check_extension_storage_basic(self, page) -> bool:
    ...
    def _check_extension_via_devtools(self, page) -> bool:
    ...
    def _test_browser_basic_functionality(self, session) -> bool:
        ...
        try:
            ...
            with sync_playwright() as p:
                ...
                try:
                    ...
                    js_result = page.evaluate("() => 'JavaScript working'")
    ...
    def _test_extension_webpage_interaction(
        self, session, extension_ids: List[str]
    ) -> bool:
