...
"""
    ...
    def _comprehensive_browser_extension_verification_with_real_ids(self, session, 
        ...
        try:
            ...
            results['browser_api_detection'] = self._detect_loaded_extensions(session, real_extension_ids)
            
            # Phase 4: Extension Context Validation using Real IDs
            print("    Phase 4: Extension Context Validation (Real IDs)")
            results['extension_context_validation'] = self._validate_extension_contexts(session, real_extension_ids)
            
            # Phase 5: Functional Validation
            print("    Phase 5: Extension Functional Validation")
            results['functional_validation'] = self._test_browser_basic_functionality(session)
    ...
    def _validate_extension_contexts(self, session, real_extension_ids: List[str]) -> bool:
            ...
            with sync_playwright() as p:
                ...
                try:
                    ...
                    for ext_id in real_extension_ids:
                        ...
                        try:
                            page.goto(ext_url, wait_until="domcontentloaded", timeout=10000)
                            
                            # Check basic extension environment
                            validation_result = self._check_basic_extension_environment(page, ext_id)
    ...
    def _detect_loaded_extensions(self, session, extension_ids: List[str]) -> bool:
        ...
        try:
            ...
            chrome_extension_ids = self._extract_real_extension_ids_from_browser(session)
            ...
            with sync_playwright() as p:
                ...
                try:
                    ...
                    if chrome_extension_ids:
                        ...
                        detected_via_basic = self._check_basic_extension_environment(page, chrome_extension_ids[0])
                    else:
                        # Fallback to general page check
                        print(f"    Testing extension environment in general page context...")
                        detected_via_basic = self._check_basic_extension_environment(page)
    ...
    def _check_basic_extension_environment(self, page, extension_id: Optional[str] = None) -> bool:
        """
    ...
    def _test_extension_webpage_interaction(self, session, extension_ids: List[str]) -> bool:
