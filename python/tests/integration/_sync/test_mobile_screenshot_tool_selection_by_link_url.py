...
@pytest.mark.sync
def test_mobile_link_url_present_requires_beta_take_screenshot():
    ...
    try:
        ...
        beta = session.mobile.beta_take_screenshot()
...
@pytest.mark.sync
def test_mobile_link_url_absent_requires_screenshot():
    api_key = _get_api_key_or_skip()
    ...
    try:
        ...
        with pytest.raises(AgentBayError, match=r"does not support `beta_take_screenshot\(\)`"):
            session.mobile.beta_take_screenshot()
    finally:
        session.delete()
