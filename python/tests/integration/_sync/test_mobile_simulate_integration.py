...
@pytest.mark.sync
def test_mobile_simulate_basic_flow(agent_bay):
    ...
    upload_result = service.upload_mobile_info(mobile_info)
    ...
    # Cleanup context
    agent_bay.context.delete(Context(id=context_id, name=""))


@pytest.mark.sync
def test_mobile_simulate_external_context(agent_bay):
    ...
    try:
        ...
        upload_result = service.upload_mobile_info(
        ...
        has_info = service.has_mobile_info(context_sync)
