...
class TestMobileSystemIntegration:
    ...
    @pytest.mark.asyncio
    def test_get_installed_apps(self, mobile_session):
        """
        Test retrieving installed applications.
        """
        try:
            result = mobile_session.application.get_installed_apps(
    ...
    @pytest.mark.asyncio
    def test_start_and_stop_app(self, mobile_session):
        """
    ...
    @pytest.mark.asyncio
    def test_get_clickable_ui_elements(self, mobile_session):
        """
        Test retrieving clickable UI elements.
        """
        try:
            result = mobile_session.ui.get_clickable_ui_elements(timeout_ms=10000)
    ...
    def test_send_key(self, mobile_session):
        ...
        """
        try:
            result = mobile_session.ui.send_key(KeyCode.KEYCODE_HOME)
            assert isinstance(result, BoolResult)
    ...
    @pytest.mark.asyncio
    def test_swipe(self, mobile_session):
        """
        ...
        try:
            ...
            result = mobile_session.ui.swipe(
                start_x, start_y, end_x, end_y, duration_ms
            )
            assert isinstance(result, BoolResult)
    ...
    @pytest.mark.asyncio
    def test_input_text(self, mobile_session):
        """
        Test inputting text into the active field.
        """
        try:
            text = "Hello, world!"
            result = mobile_session.ui.input_text(text)
            assert isinstance(result, BoolResult)
    ...
    @pytest.mark.asyncio
    def test_get_all_ui_elements(self, mobile_session):
        """
        Test retrieving all UI elements.
        """
        try:
            result = mobile_session.ui.get_all_ui_elements(timeout_ms=10000)
            assert isinstance(result, UIElementListResult)
    ...
    @pytest.mark.asyncio
    def test_screenshot(self, mobile_session):
        """
        Test taking a screenshot.
        """
        try:
            result = mobile_session.ui.screenshot()
