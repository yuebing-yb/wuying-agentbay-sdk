...
def test_clickable_ui_elements_bounds_rect_contract(session):
    ui = session.mobile.get_clickable_ui_elements(timeout_ms=5000)
...
@pytest.mark.sync
@pytest.mark.integration
def test_all_ui_elements_bounds_rect_contract(session):
    ui = session.mobile.get_all_ui_elements(timeout_ms=8000)
