...
@pytest.mark.asyncio
def test_set_get_labels(setup_session):
...
@pytest.mark.asyncio
def test_empty_labels_handling(setup_session):
    ...
    empty_labels = {}
    set_result = session.set_labels(empty_labels)
...
@pytest.mark.asyncio
def test_set_labels_invalid_parameters(setup_session):
    ...
    # Test None parameter
    null_result = session.set_labels(None)
