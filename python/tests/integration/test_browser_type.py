...
class TestBrowserTypeIntegration(unittest.TestCase):
    ...
    def test_browser_type_with_other_options(self):
        ...
        self.assertEqual(browser_option.user_agent, "Mozilla/5.0 (Test) AppleWebKit/537.36")
        ...
        success = self.session.browser.initialize_async(browser_option)
        self.assertTrue(success, "Failed to initialize browser with Chrome and other options")
