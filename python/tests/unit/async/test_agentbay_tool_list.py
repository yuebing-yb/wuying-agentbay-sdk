...
class TestAsyncAgentBayToolList(unittest.IsolatedAsyncioTestCase):
    @pytest.mark.asyncio
    async def test_build_session_from_response_sets_session_mcp_tools(self):
        from agentbay._async.agentbay import AsyncAgentBay
        from agentbay._common.params.session_params import CreateSessionParams

        agent_bay = object.__new__(AsyncAgentBay)
        ...
        session = await agent_bay._build_session_from_response(
    ...
    @pytest.mark.asyncio
    async def test_get_sets_session_mcp_tools_from_get_session_result(self):
        from agentbay._async.agentbay import AsyncAgentBay
        ...
        result = await agent_bay.get("sid-2")
