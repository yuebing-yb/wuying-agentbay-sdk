...
class TestAsyncBrowserContextPolicy(unittest.IsolatedAsyncioTestCase):
    ...
    @pytest.mark.asyncio
    async def test_default_sync_mode_is_standard(self):
    ...
    @pytest.mark.asyncio
    async def test_explicit_minimal_sync_mode(self):
        bc = BrowserContext(
    ...
    @pytest.mark.asyncio
    async def test_standard_mode_policy(self):
    ...
    @pytest.mark.asyncio
    async def test_minimal_mode_policy(self):
