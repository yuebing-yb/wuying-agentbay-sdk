...
class TestCookbookOpenClawCommandBuilder(unittest.IsolatedAsyncioTestCase):
    @pytest.mark.asyncio
    async def test_build_command_without_feishu(self):
    ...
    @pytest.mark.asyncio
    async def test_build_command_with_feishu(self):
        module = _load_cookbook_module()
        env = module.OpenClawEnv(
    ...
    @pytest.mark.asyncio
    async def test_build_command_feishu_partial_raises(self):
        module = _load_cookbook_module()
        env = module.OpenClawEnv(
            dashscope_api_key=None,
            dingtalk_client_id="dt-id",
    ...
    @pytest.mark.asyncio
    async def test_build_command_dingtalk_partial_raises(self):
        module = _load_cookbook_module()
        env = module.OpenClawEnv(
            dashscope_api_key=None,
            dingtalk_client_id="dt-id",
    ...
    @pytest.mark.asyncio
    async def test_build_command_none_when_no_config(self):
        module = _load_cookbook_module()
        env = module.OpenClawEnv(
            dashscope_api_key=None,
            dingtalk_client_id=None,
