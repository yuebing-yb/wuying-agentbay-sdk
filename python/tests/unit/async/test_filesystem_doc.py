...
def main():
    ...
    try:
        ...
        await filesystem.write_file("/tmp/agentbay_test/file1.txt", "Content 1", mode="overwrite")
        ...
        await filesystem.write_file(test_watch_file, "Watch test content", mode="overwrite")
        
        time.sleep(2)
        
        print("Modifying the test file...")
        await filesystem.write_file(test_watch_file, "Modified watch test content", mode="overwrite")
