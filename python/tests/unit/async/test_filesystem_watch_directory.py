...
from agentbay import FileChangeEvent, FileChangeResult, AsyncFileSystem
...
class TestAsyncFileChangeEvent(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_file_change_event_init(self):
        """Test FileChangeEvent initialization."""
        event = FileChangeEvent(
            event_type="modify", path="/tmp/test.txt", path_type="file"
        )
    ...
    async def test_file_change_event_repr(self):
        """Test FileChangeEvent string representation."""
        event = FileChangeEvent(
            event_type="create", path="/tmp/new_file.txt", path_type="file"
        )
    ...
    async def test_file_change_event_to_dict(self):
        """Test FileChangeEvent to_dict method."""
        event = FileChangeEvent(
            event_type="delete", path="/tmp/deleted.txt", path_type="file"
        )
    ...
    async def test_file_change_event_from_dict(self):
    ...
    async def test_file_change_event_from_dict_missing_fields(self):
...
class TestAsyncFileChangeResult(unittest.IsolatedAsyncioTestCase):
    """Test FileChangeResult class."""

    @pytest.mark.asyncio


    async def test_file_change_result_init(self):
    ...
    async def test_file_change_result_has_changes(self):
    ...
    async def test_file_change_result_get_modified_files(self):
    ...
    async def test_file_change_result_get_created_files(self):
    ...
    async def test_file_change_result_get_deleted_files(self):
...
class TestAsyncFileSystemWatchDirectory(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_get_file_change_failure(self):
    ...
    async def test_get_file_change_invalid_json(self):
    ...
    async def test_watch_directory_callback_exception(self):
