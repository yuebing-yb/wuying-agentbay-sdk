...
class TestGetCdpLink:
    ...
    async def test_get_cdp_link_success(self, client):
    ...
    async def test_get_cdp_link_with_options(self, client):
    ...
    async def test_get_cdp_link_failure(self, client):
...
class TestGetAdbLink:
    ...
    async def test_get_adb_link_success(self, client):
    ...
    async def test_get_adb_link_with_options(self, client):
    ...
    async def test_get_adb_link_failure(self, client):
