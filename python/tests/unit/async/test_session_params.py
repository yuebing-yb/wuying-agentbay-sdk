...
class TestAsyncCreateSessionParams(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_default_initialization(self):
        ...
        self.assertIsNone(params.idle_release_timeout)

    @pytest.mark.asyncio
    async def test_idle_release_timeout_default_when_none(self):
        """Test that idle_release_timeout is None when None is provided."""
    ...
    async def test_labels_json_conversion(self):
    ...
    async def test_extra_configs_initialization(self):
    ...
    async def test_mobile_extra_config_comprehensive(self):
    ...
    async def test_app_manager_rule_validation(self):
    ...
    async def test_extra_configs_serialization_comprehensive(self):
