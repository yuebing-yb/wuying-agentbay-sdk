...
class TestAsyncAgentComputer(unittest.TestCase):
    ...
    def test_computer_task_execute_success(self):
        ...
        result = self.agent.computer.execute_task("Hello, Computer Agent", int(self.max_try_times))
    ...
    def test_computer_execute_task_error(self):
        ...
        self.session.call_mcp_tool.return_value = mock_result
        result = self.agent.computer.execute_task("Hello, Computer Agent", self.max_try_times)
        self.assertIsInstance(result, ExecutionResult)
    ...
    def test_computer_task_async_execute_timeout(self):
        ...
        result = self.agent.computer.async_execute_task("Hello, Computer Agent")
        self.assertIsInstance(result, ExecutionResult)
        self.assertTrue(result.success)
        self.assertEqual(result.request_id, "request-123")
...
class TestAsyncAgentBrowser(unittest.TestCase):
    ...
    def test_browser_task_execute_success(self):
        ...
        result = self.agent.browser.execute_task("Hello, Browser Agent", int(self.max_try_times))
        self.assertIsInstance(result, ExecutionResult)
        self.assertTrue(result.success)
        self.assertEqual(result.request_id, "request-123")
        self.assertEqual(result.task_status, "finished")
    ...
    def test_browser_execute_task_error(self):
        ...
        self.session.call_mcp_tool.return_value = mock_result
        result = self.agent.browser.execute_task("Hello, Browser Agent", self.max_try_times)
        self.assertIsInstance(result, ExecutionResult)
        self.assertFalse(result.success)
        self.assertEqual(result.request_id, "request-123")
        self.assertEqual(result.error_message, "Task execution failed")
    ...
    def test_browser_task_async_execute_timeout(self):
        ...
        result = self.agent.browser.async_execute_task("Hello, Browser Agent")
        self.assertIsInstance(result, ExecutionResult)
        self.assertTrue(result.success)
        self.assertEqual(result.request_id, "request-123")
        self.assertEqual(result.task_status, "running")
