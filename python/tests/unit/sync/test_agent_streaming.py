...
import json
import unittest
from unittest.mock import MagicMock, MagicMock, patch, call

from agentbay import Agent, ExecutionResult, McpToolResult, AgentEvent
...
class TestMobileAgentStreamingBackwardsCompatibility(unittest.TestCase):
    ...
    def test_no_streaming_params_uses_polling(self):
...
class TestMobileAgentStreamingWSPath(unittest.TestCase):
    ...
    def test_on_event_callback_triggers_ws_path(self):
        ...
        mock_handle.wait_end = MagicMock(return_value=end_data)

        def mock_call_stream(**kwargs):
    ...
    def test_stream_true_triggers_ws_path(self):
    ...
    def test_on_thought_callback_dispatched(self):
    ...
    def test_on_tool_call_and_tool_result_callbacks(self):
    ...
    def test_on_event_receives_all_events(self):
    ...
    def test_on_event_and_typed_callbacks_both_fire(self):
    ...
    def test_ws_error_in_end_signal(self):
    ...
    def test_ws_exception_returns_error_result(self):
    ...
    def test_ws_request_includes_correct_params(self):
...
class TestBrowserAgentStreamingWSPath(unittest.TestCase):
    ...
    def test_browser_stream_triggers_ws_path(self):
        ...
        mock_ws_client.call_stream = mock_call_stream
        self.session._get_ws_client = MagicMock(return_value=mock_ws_client)
        self.session._ws_client = mock_ws_client

        result = self.agent.browser.execute_task_and_wait(
...
class TestComputerAgentStreamingWSPath(unittest.TestCase):
    ...
    def test_computer_stream_triggers_ws_path(self):
        ...
        result = self.agent.computer.execute_task_and_wait(
            "Create a text file",
            timeout=60,
