...
class TestLinkHttpClientReuse(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.session = Session(self.agent_bay, "test_session_id")
    ...
    def test_get_link_http_client_creates_client(self):
    ...
    def test_get_link_http_client_returns_same_instance(self):
    ...
    def test_close_link_http_client_sets_none(self):
        ...
        self.session._close_link_http_client()
        self.assertIsNone(self.session._link_http_client)

    def test_close_link_http_client_when_none(self):
    ...
    @patch("agentbay._sync.session.Session.get_status")
    def test_delete_closes_link_http_client(self, mock_get_status):
        """Session.delete() should close the link HTTP client in its finally block."""
        from agentbay._sync.session import SessionStatusResult
    ...
    def test_call_mcp_tool_link_url_uses_shared_client(self, mock_post):
        ...
        self.session._call_mcp_tool_link_url(
