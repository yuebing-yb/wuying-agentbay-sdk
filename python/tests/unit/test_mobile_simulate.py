...
from agentbay.mobile_simulate import MobileSimulateService, MobileSimulateUploadResult
...
class TestMobileSimulateUploadResult(unittest.TestCase):
    def test_upload_result_success(self):
        result = MobileSimulateUploadResult(
            success=True,
            mobile_simulate_context_id="context-123"
        )
...
class TestMobileSimulateService(unittest.TestCase):
    def setUp(self):
    ...
    def test_initialization(self):
        ...
        self.assertEqual(self.mobile_simulate_service.simulate_mode, MobileSimulateMode.PROPERTIES_ONLY)
    ...
    def test_set_and_get_simulate_mode(self):
        ...
        self.assertEqual(self.mobile_simulate_service.get_simulate_mode(), MobileSimulateMode.ALL)
        
        self.mobile_simulate_service.set_simulate_mode(MobileSimulateMode.SENSORS_ONLY)
        self.assertEqual(self.mobile_simulate_service.get_simulate_mode(), MobileSimulateMode.SENSORS_ONLY)
    ...
    def test_set_and_get_simulate_context_id(self):
        ...
        self.assertEqual(self.mobile_simulate_service.get_simulate_context_id(), context_id)
        self.assertTrue(self.mobile_simulate_service.use_internal_context)
    ...
    def test_get_simulate_config_with_external_context(self):
        ...
        self.mobile_simulate_service.set_simulate_enable(True)
        self.mobile_simulate_service.set_simulate_mode(MobileSimulateMode.PROPERTIES_ONLY)
    ...
    def test_has_mobile_info_exists(self):
        ...
        self.agent_bay.context.list_files.return_value = mock_list_result
    ...
    @patch('agentbay.mobile_simulate.requests.put')
    def test_upload_mobile_info_success_without_context(self, mock_put):
        ...
        self.agent_bay.context.get.return_value = mock_context_result
        
        mock_upload_url = MagicMock()
        mock_upload_url.success = True
        mock_upload_url.url = "https://test-upload-url.com"
        self.agent_bay.context.get_file_upload_url.return_value = mock_upload_url
        
        mock_response = MagicMock()
        mock_response.status_code = 200
        mock_put.return_value = mock_response
        
        result = self.mobile_simulate_service.upload_mobile_info(mobile_dev_info)
        
        self.assertTrue(result.success)
        self.assertEqual(result.mobile_simulate_context_id, "new-context")
        self.assertTrue(self.mobile_simulate_service.use_internal_context)
        mock_put.assert_called_once_with("https://test-upload-url.com", data=mobile_dev_info)

    @patch('agentbay.mobile_simulate.requests.put')
    def test_upload_mobile_info_success_with_context(self, mock_put):
        ...
        result = self.mobile_simulate_service.upload_mobile_info(mobile_dev_info, context_sync)
    ...
    @patch('agentbay.mobile_simulate.requests.put')
    def test_upload_mobile_info_upload_failed(self, mock_put):
        """Test handling upload request failure"""
        import requests
        mobile_dev_info = json.dumps({"device": "test"})
    ...
    def test_upload_mobile_info_with_context_missing_context_id(self):
        ...
        with self.assertRaises(ValueError) as context:
            self.mobile_simulate_service.upload_mobile_info(mobile_dev_info, context_sync)
        self.assertIn("context_sync.context_id is required", str(context.exception))
    ...
    def test_update_context_external(self):
        ...
        self.mobile_simulate_service._update_context(False, "external-ctx-123", context_sync)
    ...
    def test_update_context_external_without_context_sync(self):
        ...
        with self.assertRaises(ValueError) as context:
            self.mobile_simulate_service._update_context(False, "external-ctx-123", None)
        self.assertIn("context_sync is required", str(context.exception))
    ...
    def test_create_context_for_simulate_success(self):
        ...
        result = self.mobile_simulate_service._create_context_for_simulate()
