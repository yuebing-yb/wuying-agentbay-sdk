...
export declare class WebSocket extends EventEmitter {
  ...
  constructor(address: string, protocols?: string | string[], options?: WsClientOptions);

  close(code?: number, data?: string | Buffer): void;
  send(data: string | Buffer | ArrayBuffer | SharedArrayBuffer, callback?: (err?: Error) => void): void;
  send(data: string | Buffer | ArrayBuffer | SharedArrayBuffer, options: { compress?: boolean; binary?: boolean; fin?: boolean; mask?: boolean }, callback?: (err?: Error) => void): void;
