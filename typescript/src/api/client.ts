...
export default class Client extends OpenApi {
   ...
   */
  async getContextInfoWithOptions(request: $_model.GetContextInfoRequest, runtime: $dara.RuntimeOptions): Promise<$_model.GetContextInfoResponse> {
    request.validate();
    let body : {[key: string ]: any} = { };
    if (!$dara.isNull(request.authorization)) {
      body["Authorization"] = request.authorization;
    ...
    return $dara.cast<$_model.GetContextInfoResponse>(await this.callApi(params, req, runtime), new $_model.GetContextInfoResponse({}));
  }
   ...
   * @returns GetContextInfoResponse
   */
  async getContextInfo(request: $_model.GetContextInfoRequest): Promise<$_model.GetContextInfoResponse> {
    let runtime = new $dara.RuntimeOptions({ });
  ...
  async syncContextWithOptions(request: $_model.SyncContextRequest, runtime: $dara.RuntimeOptions): Promise<$_model.SyncContextResponse> {
    ...
    return $dara.cast<$_model.SyncContextResponse>(await this.callApi(params, req, runtime), new $_model.SyncContextResponse({}));
  }
   ...
   * @returns SyncContextResponse
   */
  async syncContext(request: $_model.SyncContextRequest): Promise<$_model.SyncContextResponse> {
    let runtime = new $dara.RuntimeOptions({ });
