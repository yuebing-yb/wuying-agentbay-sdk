 ...
 */
export const RESOLUTION_LOCK_TEMPLATE =
  "setprop sys.wuying.lockres {lock_switch}";
 ...
 */
export const HIDE_NAVIGATION_BAR_TEMPLATE =
 ...
 */
export const SHOW_NAVIGATION_BAR_TEMPLATE =
 ...
 */
export function getMobileCommandTemplate(
  templateName: string
): string | undefined {
