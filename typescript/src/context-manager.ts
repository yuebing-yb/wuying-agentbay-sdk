...
export class ContextManager {
  ...
  async infoWithParams(contextId?: string, path?: string, taskType?: string): Promise<ContextInfoResult> {
  ...
  async syncWithParams(contextId?: string, path?: string, mode?: string): Promise<ContextSyncResult> {
