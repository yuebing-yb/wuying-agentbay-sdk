...
describe("Computer", () => {
  ...
  describe("Mouse Operations", () => {
    ...
    test("clickMouse should validate button parameter", async () => {
      // Act & Assert
      await expect(
        computer.clickMouse(100, 200, "invalid" as any)
    ...
    test("scroll should validate direction parameter", async () => {
      // Act & Assert
      await expect(
        computer.scroll(100, 200, "invalid" as any, 1)
    ...
    test("clickMouse should accept MouseButton.DOUBLE_LEFT enum", async () => {
      ...
      // Act
      const result = await computer.clickMouse(
        100,
        200,
    ...
    test("dragMouse should accept MouseButton enum", async () => {
      ...
      // Act
      const result = await computer.dragMouse(
        100,
        100,
        200,
        200,
