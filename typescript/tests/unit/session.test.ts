...
describe('TestSession', () => {
  ...
  describe('test_delete_success', () => {
    it('should delete session successfully', async () => {
      ...
      expect(mockAgentBay.removeSession.calledOnceWith('test_session_id')).toBe(true);
  ...
  describe('test_delete_failure', () => {
    it('should handle delete failure', async () => {
      ...
      await expect(mockSession.delete())
        .rejects.toThrow('Failed to delete session: Error: Test error');
  ...
  describe('test_info_failure', () => {
    it('should handle info failure', async () => {
      ...
      await expect(mockSession.info())
        .rejects.toThrow('Failed to get session info for session test_session_id: Error: Get session info failed');
  ...
  describe('test_get_link_failure', () => {
    it('should handle get link failure', async () => {
      ...
      await expect(mockSession.getLink())
        .rejects.toThrow('Failed to get link for session test_session_id: Error: Get link failed');
